...
Example invocation:
    ...
    $ python runner.py ~/googleCloudSdk
"""
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        'sdk_path',
        help='/Users/tantaile/Desktop/Python/ams-app/googleCloudSdk')
    parser.add_argument(
        '--test-path',
        help='/Users/tantaile/Desktop/Python/ams-app/tests/create_user_test.py',
        default=os.getcwd())
    parser.add_argument(
        '--test-pattern',
        help='/Users/tantaile/Desktop/Python/ams-app/tests/create_user_test.py',
