...
def final(f):
    """This decorators can be used to indicate to type checkers that
...
def no_type_check_decorator(decorator):
    """Decorator to give another decorators the @no_type_check effect.

    This wraps the decorators with something that wraps the decorated
