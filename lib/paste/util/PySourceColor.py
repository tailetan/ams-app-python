...
Features:
 ...
 -Can tokenize and colorize:
    ...
    decorators / name
    keywords
    arguments class/def/decorators
    linenumbers
    names
    text
...
class Parser(object):
    ...
    def __call__(self, toktype, toktext, srow_col, erow_col, line):
        ...
        if token.LPAR <= toktype and toktype <= token.OP:
            ...
            if toktext == '@':
                toktype = DECORATOR
                # Set a flag if this was the decorators start so
                # the decorators name and arguments can be identified
        ...
        # Look for class, def, decorators name
        ...
        # Seperate errors from decorators
            ...
            # Bug fix for py2.2 linenumbers with decorators
                ...
                # What if we have a decorators after a >>> or ...
                #p = line.find('@')
