...
class TaskQueueServiceError(ProtocolBuffer.ProtocolMessage):
  ...
  _ErrorCode_NAMES = {
    ...
    29: "INVALID_DISPATCH_DEADLINE",
    10000: "DATASTORE_ERROR",
    10001: "DATASTORE_BAD_REQUEST",
    10002: "DATASTORE_CONCURRENT_TRANSACTION",
    10003: "DATASTORE_INTERNAL_ERROR",
    10004: "DATASTORE_NEED_INDEX",
    10005: "DATASTORE_TIMEOUT",
    10006: "DATASTORE_PERMISSION_DENIED",
    10007: "DATASTORE_BIGTABLE_ERROR",
    10008: "DATASTORE_COMMITTED_BUT_STILL_APPLYING",
    10009: "DATASTORE_CAPABILITY_DISABLED",
    10010: "DATASTORE_TRY_ALTERNATE_BACKEND",
    10011: "DATASTORE_SAFE_TIME_TOO_OLD",
    10012: "DATASTORE_RESOURCE_EXHAUSTED",
    10013: "DATASTORE_NOT_FOUND",
    10014: "DATASTORE_ALREADY_EXISTS",
    10015: "DATASTORE_FAILED_PRECONDITION",
    10016: "DATASTORE_UNAUTHENTICATED",
    10017: "DATASTORE_ABORTED",
    10018: "DATASTORE_SNAPSHOT_VERSION_TOO_OLD",
  }
...
class TaskQueueAddRequest(ProtocolBuffer.ProtocolMessage):
  ...
  has_dispatch_deadline_usec_ = 0
  dispatch_deadline_usec_ = 0
  ...
  def dispatch_deadline_usec(self): return self.dispatch_deadline_usec_

  def set_dispatch_deadline_usec(self, x):
    self.has_dispatch_deadline_usec_ = 1
    self.dispatch_deadline_usec_ = x

  def clear_dispatch_deadline_usec(self):
    if self.has_dispatch_deadline_usec_:
      self.has_dispatch_deadline_usec_ = 0
      self.dispatch_deadline_usec_ = 0

  def has_dispatch_deadline_usec(self): return self.has_dispatch_deadline_usec_
  ...
  def MergeFrom(self, x):
    ...
    if (x.has_dispatch_deadline_usec()): self.set_dispatch_deadline_usec(x.dispatch_deadline_usec())
  ...
  def Equals(self, x):
    ...
    if self.has_dispatch_deadline_usec_ != x.has_dispatch_deadline_usec_: return 0
    if self.has_dispatch_deadline_usec_ and self.dispatch_deadline_usec_ != x.dispatch_deadline_usec_: return 0
    return 1
  ...
  def ByteSize(self):
    ...
    if (self.has_dispatch_deadline_usec_): n += 2 + self.lengthVarInt64(self.dispatch_deadline_usec_)
    return n + 3
  ...
  def Clear(self):
    ...
    self.clear_dispatch_deadline_usec()
  ...
  def OutputUnchecked(self, out):
    ...
    if (self.has_dispatch_deadline_usec_):
      out.putVarInt32(176)
      out.putVarInt64(self.dispatch_deadline_usec_)
  ...
  def TryMerge(self, d):
    while d.avail() > 0:
      ...
      if tt == 170:
        ...
        continue
      if tt == 176:
        self.set_dispatch_deadline_usec(d.getVarInt64())
        continue
  ...
  def __str__(self, prefix="", printElemNumber=0):
    ...
    if self.has_cron_retry_parameters_:
      ...
      res+=prefix+">\n"
    if self.has_dispatch_deadline_usec_: res+=prefix+("dispatch_deadline_usec: %s\n" % self.DebugFormatInt64(self.dispatch_deadline_usec_))
    return res
  ...
  _TYPES = _BuildTagLookupTable({
    ...
    22: ProtocolBuffer.Encoder.NUMERIC,
...
class TaskQueueQueryTasksResponse(ProtocolBuffer.ProtocolMessage):
  ...
  kTaskdispatch_deadline_usec = 28
