...
The main decorators :class:`wsgify` turns a function into a WSGI
...
class wsgify(object):
    ...
    decorators.  Most notably, you can use a :class:`webob.Request`
    subclass, like::
    ...
    * Raise an exception from :mod:`webob.exc`
    ...
    You can also subclass this decorators; the most useful things to do
